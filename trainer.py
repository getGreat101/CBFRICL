    ...
    def train_model(self):
        ...
        for epoch in range(self.epochs):
            ...
            current_epoch_data = pd.DataFrame({
                "Epoch": [epoch + 1],
                "hit@10": [test_metric_dict["hit@10"]],
                "ndcg@10": [test_metric_dict["ndcg@10"]],
                "hit@20": [test_metric_dict["hit@20"]],
                "ndcg@20": [test_metric_dict["ndcg@20"]],
                "hit@50": [test_metric_dict["hit@50"]],
                "ndcg@50": [test_metric_dict["ndcg@50"]],
                "hit@80": [test_metric_dict["hit@80"]],
                "ndcg@80": [test_metric_dict["ndcg@80"]]
            })
